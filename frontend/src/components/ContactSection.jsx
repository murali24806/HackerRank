...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="section-padding glass-contact-section">
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="section-header text-center reveal active" style={{ marginBottom: '60px' }}>
          ...
          <h2 className="section-title glass-contact-title">Let's Build Together</h2>
        ...
        <div className="glass-contact-wrapper reveal active">
          
          {/* Left Column: Contact Info (Light Glass) */}
          <div className="contact-info glass-contact-card" style={{ flex: '1 1 400px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
          ...
          <div className="contact-form-container glass-contact-card" style={{ flex: '1 1 500px', position: 'relative' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <textarea placeholder="Tell us about your query..." value={message} onChange={(e) => setMessage(e.target.value)} rows="5" required className="glass-input" style={{ resize: 'vertical' }}></textarea>
              </div>
