...
export const PhotoGallery = ({
  ...
  // Exactly arranged photos matching the reference screenshot:
  // 1. Far Left (Portrait): Couple at ruins (zIndex: 20)
  // 2. Left-Center (Landscape): Stone wall/sea, overlaps Photo 1 (zIndex: 35)
  // 3. Center (Portrait Hero): Man with heart light, overlaps both 2 & 4 (zIndex: 50)
  // 4. Right-Center (Landscape): Couple on mountain, overlaps Photo 5 (zIndex: 35)
  // 5. Far Right (Portrait): Peacock, tucked behind Photo 4 (zIndex: 20)
  const photos = [
    {
      id: 1,
      order: 0,
  ...
  return (
    <div className="hero-photo-gallery relative w-full my-8 select-none">
      ...
      {/* Header text matching user reference screenshot */}
        ...
        >
          ...
          >
            ...
            <div className="relative h-[260px] w-[240px]">
              {/* Render sorted by z-index so DOM stacking matches zIndex correctly */}
              {[...photos]
